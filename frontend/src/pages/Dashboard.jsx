    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Paper 
        sx={{ 
          p: 3, 
          mb: 4, 
          background: 'linear-gradient(45deg, #6F4E37 30%, #8B5E3C 90%)', 
          color: 'white',
          display: 'flex',
          alignItems: 'center',
        ...
        <Box display="flex" alignItems="center" gap={2}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ opacity: 0.9 }}>
              View products, update stock, and explore the menu.
            </Typography>
          </Box>
        </Box>
        <Button 
          ...
          <Paper sx={{ p: 3 }}>
            ...
            {Object.entries(stats.statusBreakdown || {}).map(([status, count]) => (
              <Box key={status} display="flex" alignItems="center" mb={1}>
                ...
                <LinearProgress
                  variant="determinate"
                  value={(count / stats.totalOrders) * 100 || 0}
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3 }}>
            ...
            <Box mb={2}>
              ...
              <Typography variant="h5">${stats.todayRevenue?.toFixed(2) || '0.00'}</Typography>
            </Box>
            <Box mb={2}>
              <Typography variant="body2" color="text.secondary">This Week</Typography>
              <Typography variant="h5">${stats.weekRevenue?.toFixed(2) || '0.00'}</Typography>
            </Box>
            <Box>
              <Typography variant="body2" color="text.secondary">Total</Typography>
              <Typography variant="h5">${stats.totalRevenue?.toFixed(2) || '0.00'}</Typography>
            </Box>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
